...
public interface TeamClient {
  ...
  PlayerTagsUpdateResponse updateTag(
    String username,
    String tag,
  ...
  default MojangProfile getMojangProfile(String username) {
    try {
      HttpResponse<MojangProfile> response = Unirest
