...
public class DemomanClass extends GameClass {
    public DemomanClass(Ability... abilities) {
        super(abilities);
        ...
        super.setItem(SlotType.CHESTPLATE.getSlot(), ItemFactory.createItem(Material.IRON_CHESTPLATE));
        super.setItem(SlotType.LEGGINGS.getSlot(), ItemFactory.createItem(Material.LEATHER_LEGGINGS));
        super.setItem(SlotType.BOOTS.getSlot(), ItemFactory.createItem(Material.LEATHER_BOOTS));
    }
}
