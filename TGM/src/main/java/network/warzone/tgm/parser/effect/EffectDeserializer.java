...
public class EffectDeserializer implements JsonDeserializer<PotionEffect> {
  ...
  @Getter
  @Setter
  private static EffectTagParser<PotionEffectType> typeParser = new EffectTypeParser();

  @Getter
  @Setter
  private static EffectTagParser<Integer> durationParser = new EffectDurationParser();

  @Getter
  @Setter
  private static EffectTagParser<Integer> amplifierParser = new EffectAmplifierParser();

  @Getter
  @Setter
  private static EffectTagParser<Boolean> ambientParser = new EffectAmbientParser();

  @Getter
  @Setter
  private static EffectTagParser<Boolean> particleParser = new EffectParticleParser();
