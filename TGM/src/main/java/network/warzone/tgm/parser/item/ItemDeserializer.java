...
public class ItemDeserializer implements JsonDeserializer<ItemStack> {
  ...
  private static Map<ItemMetaParserType, ItemMetaParser> metaParsers = new HashMap<ItemMetaParserType, ItemMetaParser>() {
    {
      put(
        ItemMetaParserType.DISPLAY_NAME,
        ItemMetaParserType.DISPLAY_NAME.newDefaultInstance()
      );
      put(
        ItemMetaParserType.LORE,
        ItemMetaParserType.LORE.newDefaultInstance()
      );
      put(
        ItemMetaParserType.DURABILITY,
        ItemMetaParserType.DURABILITY.newDefaultInstance()
      );
      put(
        ItemMetaParserType.ENCHANTMENTS,
        ItemMetaParserType.ENCHANTMENTS.newDefaultInstance()
      );
      put(
        ItemMetaParserType.UNBREAKABLE,
        ItemMetaParserType.UNBREAKABLE.newDefaultInstance()
      );
      put(
        ItemMetaParserType.FLAGS,
        ItemMetaParserType.FLAGS.newDefaultInstance()
      );
      put(
        ItemMetaParserType.SKULL_OWNER,
        ItemMetaParserType.SKULL_OWNER.newDefaultInstance()
      );
      put(
        ItemMetaParserType.POTION,
        ItemMetaParserType.POTION.newDefaultInstance()
      );
      put(
        ItemMetaParserType.BOOK,
        ItemMetaParserType.BOOK.newDefaultInstance()
      );
      put(
        ItemMetaParserType.COLOR,
        ItemMetaParserType.COLOR.newDefaultInstance()
      );
      put(
        ItemMetaParserType.CAN_PLACE_ON,
        ItemMetaParserType.CAN_PLACE_ON.newDefaultInstance()
      );
      put(
        ItemMetaParserType.CAN_DESTROY,
        ItemMetaParserType.CAN_DESTROY.newDefaultInstance()
      );
    }
  };
  ...
  public static void setItemMetaParser(
    ItemMetaParserType type,
    ItemMetaParser parser
  ) {
  ...
  public static ItemStack parse(JsonElement jsonElement) {
    if (jsonElement.isJsonPrimitive()) {
      Material material = Material.valueOf(
        Strings.getTechnicalName(jsonElement.getAsString())
      );
