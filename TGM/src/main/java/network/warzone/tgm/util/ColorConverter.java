...
public class ColorConverter {
  ...
  private static Material[] orderedWool = {
    Material.WHITE_WOOL,
  ...
  private static Material[] orderedCarpet = {
  ...
  private static Material[] orderedTerracotta = {
  ...
  private static Material[] orderedStainedGlassPane = {
  ...
  public static Material convertChatColorToColoredBlock(
