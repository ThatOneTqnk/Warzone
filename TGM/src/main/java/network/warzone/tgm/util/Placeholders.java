...
public class Placeholders {
  ...
  public static void addPlaceholders(
    ...
    placeholders.put(
      "timeElapsed",
      String.valueOf(match.getModule(TimeModule.class).getTimeElapsed())
    );
    placeholders.put(
      "timeElapsedFormatted",
      Strings.formatTime(match.getModule(TimeModule.class).getTimeElapsed())
    );
    placeholders.put("mapName", match.getMapContainer().getMapInfo().getName());
    placeholders.put(
      "mapGametype",
      match.getMapContainer().getMapInfo().getGametype().name()
    );
    placeholders.put(
      "mapGametypeName",
      match.getMapContainer().getMapInfo().getGametype().getName()
    );
  }
  ...
  public static void addPlaceholders(
    ...
    placeholders.put(
      "countdownTime",
      String.valueOf(countdown.getTimeMaxSeconds())
    );
    placeholders.put(
      "countdownTimeFormatted",
      Strings.formatTime(countdown.getTimeMaxSeconds())
    );
    placeholders.put(
      "countdownTimeLeft",
      String.valueOf(countdown.getTimeLeftSeconds())
    );
    placeholders.put(
      "countdownTimeLeftFormatted",
      Strings.formatTime(countdown.getTimeLeftSeconds())
    );
  }
}
